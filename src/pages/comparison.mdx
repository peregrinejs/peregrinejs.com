...
Frame](/docs/ios/architecture#web-frames) that the web layer will be able to
access. This is what's known as the [remote
interface](/docs/ios/architecture#remote-interfaces).
...
- Peregrine is primarily managed and maintained by
  [@imhoffd](https://twitter.com/imhoffd), an Ionic alumni (2015-2020).
