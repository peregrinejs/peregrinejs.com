...
Unfortunately for developers using these solutions, a framework whose scope
encompasses several entire native platforms has a few downsides:
...
- Advanced views: interactive animations/games, Google Maps, etc.
