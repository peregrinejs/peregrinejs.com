...
This page will explain **why** Peregrine was created, **how** it's different
from existing solutions, **who** it's meant for, and the **philosophy** behind
it.
...
1. Apps become **nearly impossible to migrate** away from these solutions,
   mostly because they require you to use their custom view layer, coupling
   your views to third-party syntax and runtime that are otherwise completely
   unsupported.
...
within the confines of the framework, you won't have to worry about the
platform itself. Unfortunately for developers using these solutions, a
framework whose scope encompasses several entire native platforms has a few
downsides:
...
1. Native functionality is pre-implemented, often leading to **low-fidelity
   native API usage, cliché interactions, platform conventions not being
...
tooling to abstract the platform, Peregrine provides documentation for
...
**Further Reading**: _[A World Without
Plugins](https://www.swyx.io/a-world-without-plugins-cig)_, by
