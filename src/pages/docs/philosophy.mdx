...
This page will explain **why** Peregrine was created, **who** it's meant for,
and the **philosophy** behind its architecture.
...
Recipes are often combined and then hooked up to Peregrine connectors to
provide native functionality to your web app.
