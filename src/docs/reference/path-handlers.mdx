...
[`InternalStoragePathHandler`](#internalstoragepathhandler), which serves
static files from almost any directory on the native device.

</T>

<T android>

Path handlers must adhere to the first-party [`WebViewAssetLoader.PathHandler`
interface](#webviewassetloaderpathhandler). One particularly useful subclass is
...
Implementers must have a `handle` method which returns a [`PathHandlerResponse`](#pathhandlerresponse).
...
See the [official
documentation](https://developer.android.com/reference/androidx/webkit/WebViewAssetLoader.InternalStoragePathHandler)
for this class.

### `WebViewAssetLoader.PathHandler`

See the [official
documentation](https://developer.android.com/reference/androidx/webkit/WebViewAssetLoader.PathHandler)
for this interface.

### `WebResourceResponse`

See the [official
documentation](https://developer.android.com/reference/android/webkit/WebResourceResponse.html)
for this class.
