...
This guide is for developers who want to quickly set up and use Peregrine in an
example {platform} app to see it in action for themselves. As a reminder, you
can use the buttons above to switch platforms for this documentation.
...
from our web content. In the interest of time, we'll be implementing a simple
ping/pong example.
